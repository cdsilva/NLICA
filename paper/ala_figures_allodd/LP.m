...
function [f_app_Train_Data, f_app_Test_Data, deltas, my_err, my_err_max, correct_app] = LP(Train_Data, Test_Data, f, my_err_thresh,  my_eps)
...
[APP_RES_TR, APP_RES_TS] = LP_iter(Train_Data, Test_Data, F_TO_APP, my_eps);
