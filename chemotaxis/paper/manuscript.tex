...
%Due to the complexity and range of microscale behaviors possible in dynamical systems,
%we use manifold learning, a class of nonlinear data-driven techniques, to analyze data.
%
...
%
%In practice, it has a similar, but not equivalent, effect as the kernel scale \epsilon. 
% 
%
...
provide us with an informative two-dimensional parametrization of the data. %which is consistent with the expected macroscopic dynamics.
%
...
%%%YGK
%%% that is because we did not use the velocities in our diffusion maps.....
%%%
%
