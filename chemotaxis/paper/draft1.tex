...
\begin{equation}
\begin{aligned}
z_1 =& (4 \pi \sqrt{t_1} + 1) \cos(4 \pi \sqrt{t_1}) \\
z_2 =& (4 \pi \sqrt{t_1} + 1) \sin(4 \pi \sqrt{t_1}) \\
z_3 =& h t_2
\end{aligned}
\end{equation}
%
where $t_1, t_2 \sim Unif(0,1)$.
%
The height of the first swiss roll is $h = 15 \pi$, while the height of the second is $h = 6 \pi$. 
%
