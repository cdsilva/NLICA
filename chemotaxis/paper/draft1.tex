...
%
The coefficients $\alpha$ and $\beta$ are functions of $\phi_{k-1}$ because we use a {\em local} linear fit; therefore, the coefficients change as a function of the domain. 
