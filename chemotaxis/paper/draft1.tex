...
Add physical examples, and Amit's bi-spectrum, scattering....

Cite PNAS, stating that the histograms are good since they linearize any noise. 

\subsection{Metric}
Euclidean (not good, especially for histograms), Mahalanobis (good, cite PNAS, since it noise robust). Here we use EMD since it is multiscale.
Stability and regularity issues.

\section{Identify the principal components}
...
\includegraphics[height=3in]{swissroll1_evals}
