...
%
We demonstrate how extracting a parameterization of microscale data can be accomplished automatically using manifold learning techniques, and that this parameterization is consistent with the governing macroscopic dynamical model. 
%
...
%
We would like to note that we have chosen a one-parameter family of initial conditions.
%
Other initial conditions could easily be chosen, but the simplicity of this setup will allow us to easily illustrate our main points. 
