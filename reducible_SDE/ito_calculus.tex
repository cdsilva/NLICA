...
%\sum_i \left( \left( \sum_i A_{ij} \right) B_{ik} + \left( \sum_i A_{ik} \right) B_{ij} \right) \left(\delta t W_{\delta t}^i -\int_t^{t + \delta t} W_\tau^i d\tau \right) \\
&+& \left( \sum_i A_{ij} \right) \frac{1}{\epsilon} \left(\delta t \hat{W}_{\delta t}^k -\int_t^{t + \delta t} \hat{W}_\tau^k d\tau \right)  \\
...
%&+& \sum_i \left( \left( \sum_i A_{ik} \right) B_{ij} + \left( \sum_i A_{ij} \right) B_{ik} \right) \left( \int_t^{t + \delta t} W_\tau^i d\tau \right) \\ 
...
%&+& \sum_i \left( \left( \sum_i A_{ij} \right) B_{ik} + \left( \sum_i A_{ik} \right) B_{ij} \right) \delta t W_{\delta t}^i \\
