function [data_init, data_burst_init, data1, data1_burst, t] = simulate_quadratic2(nsteps, dt, nsteps_burst, dt_burst, epsilon, data_init)
...
quad_scale = 1.0;
f1 = @(x) [x(:,1)+quad_scale*x(:,1).*x(:,2).^2/epsilon x(:,2)/sqrt(epsilon)];
