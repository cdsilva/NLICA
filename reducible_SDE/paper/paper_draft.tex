...
\begin{equation} \label{eq:multiscale_SDE}
\begin{aligned}
dx &= adt + dW_1\\
...
%
For example, in \eqref{eq:multiscale_SDE}, let $y = \frac{z}{\sqrt{\epsilon}}$. 
%
Then
\begin{equation}
\begin{aligned}
...
Note: saturation time of SDE has to be smaller than the timescales
