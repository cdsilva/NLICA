...
\frac{\partial a_2}{\partial x_2} &=& -2 x_2 \\
\frac{\partial^2 a_2}{\partial x_2^2} &=& -2
\end{aligned}
\end{equation}
...
\item $f_{1, (2)} = f_{2,(1)} = 0 $
\item $f_{(j, k)} = 0 $
\item $f_{1,(1,0)} = f_{1, (2,0)} = 0$
\item $f_{2,(1,0)} = 0$
\item $f_{2,(2,0)} = \frac{-2x_2}{\epsilon^{3/2}} $
\item $f_{(0, j)} =0$
\end{itemize}
%
and we have
...
e_{C,22} =&
 -\frac{4}{\epsilon^2 \delta t} \mathbb{E} \left[ \int_t^{t+\delta t} \int_{s_1}^{t + \delta t} x_{s_2,2} ds_2 ds_1 \right] + \mathcal{O} (\delta t^{3/2})
\end{aligned}
\end{equation}
